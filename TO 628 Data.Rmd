...
library(plyr)
data_per_day <- ddply(data,.(start_mth, start_day, usertype, day, age_group, time, day_count, Ave.Wind.Speed,TMIN...C. ,TMAX...C. ,  PRCP..mm. , SNOW..mm.), c(function(x) mean(x$tripduration), function(x) mean(x$speed), nrow))
colnames(data_per_day) = c("start_month","start_day","usertype","day","age_group","time","day_count","avg_wind_speed","TMIN","TMAX","PRCP","SNOW","avg_trip_duration","avg_speed","frequency")
