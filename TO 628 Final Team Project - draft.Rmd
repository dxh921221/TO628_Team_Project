...
rownames(frequency_model_comparison) = c("linear","knn","ann","svm","decision_tree","random_forst")
...
rownames(distance_model_comparison) = c("linear","knn","ann","svm","decision_tree","random_forst")
