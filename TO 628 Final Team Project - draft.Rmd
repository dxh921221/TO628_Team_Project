...
# Conclusion
We used various regression and machine learning algorithms in the R programming language to predict Citi Bike usage data in NYC compared to the weather. Using 2019 data for both training and testing, KNN consistently provided the highest accuracy models considering a 10% error buffer.
